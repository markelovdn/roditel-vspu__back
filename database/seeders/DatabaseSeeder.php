...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('rating_questions')->insert([
            ["title" => "Удовлетворены ли Вы качеством оказанной услуги? Соответствовало ли содержание консультации имеющейся проблеме, помог ли консультант Межрегиональной службы консультирования родителей ВГСПУ?"],
            ["title" => "Удовлетворены ли Вы условиями предоставления услуги (оценивается доступность для людей с ОВЗ, доступность записи, время ожидания от момента обращения, возможность выбора формата оказания услуги)? "],
            ["title" => "Удовлетворены ли Вы полнотой и доступностью информации о работе Службы и порядке предоставления услуг ? (при личном обращении, по телефону, на официальном сайте организации, на сайте https://roditel-vspu.ru/, на информационных стендах) "],
            ["title" => "Оцените доброжелательность и вежливость консультантов Службы"],
            ["title" => "Есть ли у Вас жалобы на работу Межрегиональной службы консультирования родителей ВГСПУ?"],
            ["title" => "Есть ли у Вас предложения и пожелания по улучшению работы Межрегиональной службы консультирования родителей ВГСПУ?"],
