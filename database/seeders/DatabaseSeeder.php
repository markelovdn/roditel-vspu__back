...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        DB::table('rating_questions')->insert([
            ["tite" => "Удовлетворены ли Вы качеством оказанной услуги? Соответствовало ли содержание консультации имеющейся проблеме, помог ли консультант Межрегиональной службы консультирования родителей ВГСПУ?"],
            ["tite" => "Удовлетворены ли Вы условиями предоставления услуги (оценивается доступность для людей с ОВЗ, доступность записи, время ожидания от момента обращения, возможность выбора формата оказания услуги)? "],
            ["tite" => "Удовлетворены ли Вы полнотой и доступностью информации о работе Службы и порядке предоставления услуг ? (при личном обращении, по телефону, на официальном сайте организации, на сайте https://roditel-vspu.ru/, на информационных стендах) "],
            ["tite" => "Оцените доброжелательность и вежливость консультантов Службы"],
            ["tite" => "Есть ли у Вас жалобы на работу Межрегиональной службы консультирования родителей ВГСПУ?"],
            ["tite" => "Есть ли у Вас предложения и пожелания по улучшению работы Межрегиональной службы консультирования родителей ВГСПУ?"],
